pfUI_translation["enUS"] = {
  ...
  ["Very Slow"] = nil,
  ["Website"] = nil,
  ["Welcome to |cff33ffccpf|cffffffffUI|r!\n\nI'm the first run wizard that will guide you through some basic configuration. If you're lazy, feel free to hit the \"Defaults\" button. If you wish to run this dialog again, go to the settings and hit the \"Reset Firstrun\" button.\n\nVisit |cff33ffcchttp://shagu.org|r to check for the latest version."] = "Bem vindo ao servidor de WoW Classic+ |cff33ffccSand|cffffffffWorlds|r!\n\nSiga os passos para a configuração básica da UI. Recomendamos deixar tudo no padrão e apenas avançar até o final. Se quiser abrir este diálogo de novo no futuro, vá nas configurações e clique em \"Reiniciar Primeira vez\".\n\nVisita |cff33ffcchttp://sandworlds.com|r para atualizar o cliente e encontrar o link do nosso discord.",
  ["Whitelist"] = nil,
